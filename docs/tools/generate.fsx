...
let githubLink = "http://github.com/TheInnerLight/NovelIO"

// Specify more information about your project
let info =
  [ "project-name", "NovelIO"
    "project-author", "Phil Curzon"
    "project-summary", "F# Functional IO Library"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/NovelIO" ]
